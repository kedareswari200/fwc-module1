...
sys.path.insert(0,'/home/hp/Desktop/matrix/CoordGeo')         #path to my scripts
#Circle Assignment
import numpy as np
...
area=A2-A1;
print('the area of smaller region bounded by the ellipse and the line is ',np.abs(area));
